...
def parse_args():
    ...
    parser.add_argument("--approach-target-speed", type=float, default=0.30)
    parser.add_argument("--descend-target-speed", type=float, default=0.15)
    parser.add_argument("--transport-target-speed", type=float, default=0.15)
    parser.add_argument("--release-target-speed", type=float, default=0.10)
    parser.add_argument("--lift-target-speed", type=float, default=0.15)
    parser.add_argument("--retreat-target-speed", type=float, default=0.30)
    ...
    parser.add_argument("--grasp-z-offset", type=float, default=0.06)
    ...
    parser.add_argument("--enclosure-vertical-tol", type=float, default=0.080)
    ...
    parser.add_argument("--grasp-mpc-horizon", type=int, default=10)
    parser.add_argument("--unified-grasp-horizon", type=int, default=1)
    parser.add_argument("--unified-grasp-max-iterations", type=int, default=15)
    parser.add_argument("--grasp-preload-force", type=float, default=8.0)
    parser.add_argument("--grasp-normal-force-max", type=float, default=40.0)
    parser.add_argument("--grasp-friction-coefficient", type=float, default=1.0)
    parser.add_argument("--grasp-friction-margin", type=float, default=0.20)
    parser.add_argument("--grasp-torsional-friction", type=float, default=0.005)
    parser.add_argument("--grasp-contact-close-rate", type=float, default=0.23)
    parser.add_argument("--grasp-close-rate-max", type=float, default=0.35)
    parser.add_argument("--grasp-slip-speed-max", type=float, default=0.025)
    parser.add_argument("--grasp-lift-safety-factor", type=float, default=1.25)
    parser.add_argument("--grasp-stable-mpc-steps", type=int, default=5)
